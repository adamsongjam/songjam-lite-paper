...
A wallet signature derives a fernet symmetric encryption key \cite{fernet2010fernet} from a Trusted Execution Enviornment (TEE) network such as Phala \cite{phala2023tee}, making the data undecipherable without key access.
